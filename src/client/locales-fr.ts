...
export const fr: Record<string, string> = {
  ...
  rename: 'Renommer',
  renameInvalid: 'Le nom ne peut pas être vide ni contenir de séparateurs de chemin.',
  delete: 'Supprimer',
  deleteTitle: 'Supprimer « {name} » ?',
  deleteDescFile: 'Ce fichier sera définitivement supprimé. Cette action est irréversible.',
  deleteDescDir: 'Ce répertoire et tout son contenu seront définitivement supprimés. Cette action est irréversible.',
  dismiss: 'Fermer',
  ...
  settingsOpenToolsDesc: 'Une fois activé, le modèle peut ouvrir des fichiers, dossiers et pages HTTP(S) dans la barre latérale via l\'outil sidebar_open',
  ...
  settingsBrowserHttpsDesc: 'Une fois activé, cliquer sur un lien externe HTTPS du chat ou de l’interface l’ouvre dans la barre latérale.',
  ...
  changesRedactOn: "Masquage actif : les secrets s'affichent en [REDACTED] ; cliquez pour désactiver (à vos risques)",
  changesRedactOff: "Masquage désactivé : le contenu s'affiche tel quel ; cliquez pour activer",
  changesRedactOnLabel: "Masquage",
