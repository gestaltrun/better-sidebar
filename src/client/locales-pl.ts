...
export const pl: Record<string, string> = {
  ...
  changesPdfRender: "Renderuj",
  changesPdfRaw: "Źródło",
  changesMdRaw: 'Źródło',
  changesWrite: 'Zapis',
  changesEdit: 'Edycja',
  ...
  deleteDescFile: 'Spowoduje to trwałe usunięcie pliku. Tej operacji nie można cofnąć.',
  deleteDescDir: 'Spowoduje to trwałe usunięcie katalogu i całej jego zawartości. Tej operacji nie można cofnąć.',
  dismiss: 'Zamknij',
  download: 'Pobierz',
  ...
  settingsOpenToolsDesc: 'Po włączeniu model może otwierać pliki, foldery i strony HTTP(S) w panelu bocznym za pomocą narzędzia sidebar_open',
  ...
  settingsBrowserHttpsDesc: 'Po włączeniu kliknięcie zewnętrznego linku HTTPS na czacie lub w interfejsie otwiera panel boczny.',
  ...
  changesRedactOn: "Redakcja włączona: tajne dane pokazywane jako [REDACTED]; kliknij, aby wyłączyć (na własne ryzyko)",
  changesRedactOff: "Redakcja wyłączona: treść pokazywana bez zmian; kliknij, aby włączyć",
  changesRedactOnLabel: "Redakcja",
