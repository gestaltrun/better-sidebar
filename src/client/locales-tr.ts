...
export const tr: Record<string, string> = {
  ...
  renameInvalid: 'Ad boş olamaz veya yol ayırıcıları içeremez.',
  delete: 'Sil',
  deleteTitle: '"{name}" silinsin mi?',
  deleteDescFile: 'Bu, dosyayı kalıcı olarak siler. Bu işlem geri alınamaz.',
  deleteDescDir: 'Bu, dizini ve tüm içeriğini kalıcı olarak siler. Bu işlem geri alınamaz.',
  dismiss: 'Kapat',
  download: 'İndir',
  ...
  settingsOpenToolsDesc: 'Etkinleştirildiğinde model, sidebar_open aracıyla kenar çubuğunda dosyaları, klasörleri ve HTTP(S) sayfalarını açabilir',
  ...
  settingsBrowserHttpsDesc: 'Açıkken sohbetteki veya arayüzdeki bir HTTPS dış bağlantısına tıklamak kenar çubuğunu açar.',
