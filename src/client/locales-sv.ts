export const sv: Record<string, string> = {
  ...
  deleteDescFile: 'Detta tar bort filen permanent. Det går inte att ångra.',
  deleteDescDir: 'Detta tar bort katalogen och allt i den permanent. Det går inte att ångra.',
  dismiss: 'Stäng',
  download: 'Ladda ner',
  ...
  settingsOpenToolsDesc: 'När aktiverat kan modellen öppna filer, mappar och HTTP(S)-sidor i sidopanelen via sidebar_open-verktyget',
  ...
  settingsBrowserHttpsDesc: 'När på, klick på en extern HTTPS-länk i chatten eller GUI öppnar sidopanelen.',
