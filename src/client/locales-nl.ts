...
export const nl: Record<string, string> = {
  ...
  renameInvalid: 'De naam mag niet leeg zijn of padscheidingstekens bevatten.',
  delete: 'Verwijderen',
  deleteTitle: '"{name}" verwijderen?',
  deleteDescFile: 'Dit verwijdert het bestand permanent. Dit kan niet ongedaan worden gemaakt.',
  deleteDescDir: 'Dit verwijdert de map en alles erin permanent. Dit kan niet ongedaan worden gemaakt.',
  dismiss: 'Sluiten',
  download: 'Downloaden',
  ...
  settingsOpenToolsDesc: 'Indien ingeschakeld kan het model bestanden, mappen en HTTP(S)-pagina\'s in de zijbalk openen via de sidebar_open-tool',
  ...
  settingsBrowserHttpsDesc: 'Indien aan, opent een klik op een externe HTTPS-link in de chat of GUI de zijbalk.',
  ...
  changesRedactOn: "Redactie aan: geheimen worden als [REDACTED] getoond; klik om uit te schakelen (op eigen risico)",
  changesRedactOff: "Redactie uit: inhoud wordt ongewijzigd getoond; klik om in te schakelen",
  changesRedactOnLabel: "Redactie",
