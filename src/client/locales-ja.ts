...
export const ja: Record<string, string> = {
  ...
  rename: '名前の変更',
  renameInvalid: '名前は空にできず、パス区切り文字を含められません。',
  delete: '削除',
  deleteTitle: '「{name}」を削除しますか？',
  deleteDescFile: 'このファイルを完全に削除します。元に戻せません。',
  deleteDescDir: 'このディレクトリと内容物をすべて完全に削除します。元に戻せません。',
  dismiss: '閉じる',
  download: 'ダウンロード',
  ...
  settingsOpenToolsDesc: 'オンにすると、モデルは sidebar_open ツールでサイドバーにファイル・フォルダー・HTTP(S) ページを開ける',
  ...
  settingsBrowserHttpsDesc: 'オンにすると、チャットや GUI の HTTPS 外部リンククリック時にサイドバーで開く。',
