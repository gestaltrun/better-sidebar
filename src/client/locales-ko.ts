...
export const ko: Record<string, string> = {
  ...
  rename: '이름 바꾸기',
  renameInvalid: '이름은 비워 둘 수 없으며 경로 구분 기호를 포함할 수 없습니다.',
  delete: '삭제',
  deleteTitle: '"{name}"을(를) 삭제할까요?',
  deleteDescFile: '이 파일이 영구적으로 삭제됩니다. 되돌릴 수 없습니다.',
  deleteDescDir: '이 디렉터리와 모든 내용이 영구적으로 삭제됩니다. 되돌릴 수 없습니다.',
  dismiss: '닫기',
  download: '다운로드',
  uploadFiles: '파일 업로드',
  uploadFolder: '폴더 업로드',
  ...
  settingsOpenToolsDesc: '켜면 모델이 sidebar_open 도구로 사이드바에서 파일·폴더·HTTP(S) 페이지를 열 수 있습니다',
  ...
  settingsBrowserHttpsDesc: '켜면 채팅이나 인터페이스에서 HTTPS 외부 링크를 클릭할 때 사이드바에서 엽니다.',
  ...
  changesRedactOn: "마스킹 켜짐: 민감 값이 [REDACTED]로 표시됩니다. 클릭하면 꺼집니다(책임 본인)",
  changesRedactOff: "마스킹 꺼짐: 내용이 그대로 표시됩니다. 클릭하면 켜집니다",
  changesRedactOnLabel: "마스킹 중",
