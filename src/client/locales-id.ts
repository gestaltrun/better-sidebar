...
export const id: Record<string, string> = {
  ...
  deleteDescFile: 'Ini menghapus file secara permanen. Tidak dapat dibatalkan.',
  deleteDescDir: 'Ini menghapus direktori dan seluruh isinya secara permanen. Tidak dapat dibatalkan.',
  dismiss: 'Tutup',
  download: 'Unduh',
  ...
  settingsOpenToolsDesc: 'Saat diaktifkan, model dapat membuka file, folder, dan halaman HTTP(S) di sidebar melalui alat sidebar_open',
  ...
  settingsBrowserHttpsDesc: 'Saat aktif, mengeklik tautan eksternal HTTPS di obrolan atau GUI membuka sidebar.',
