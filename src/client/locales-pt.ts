export const pt: Record<string, string> = {
  ...
  rename: 'Renomear',
  renameInvalid: 'O nome não pode ser vazio nem conter separadores de caminho.',
  delete: 'Excluir',
  deleteTitle: 'Excluir "{name}"?',
  deleteDescFile: 'Isso exclui o arquivo permanentemente. Esta ação não pode ser desfeita.',
  deleteDescDir: 'Isso exclui o diretório e todo o seu conteúdo permanentemente. Esta ação não pode ser desfeita.',
  dismiss: 'Fechar',
  download: 'Baixar',
  ...
  settingsOpenToolsDesc: 'Quando ativado, o modelo pode abrir arquivos, pastas e páginas HTTP(S) na barra lateral pela ferramenta sidebar_open',
  ...
  settingsBrowserHttpsDesc: 'Quando ativado, clicar em um link externo HTTPS no chat ou na interface abre na barra lateral.',
