...
export const vi: Record<string, string> = {
  ...
  rename: 'Đổi tên',
  renameInvalid: 'Tên không được để trống hoặc chứa dấu phân tách đường dẫn.',
  delete: 'Xóa',
  deleteTitle: 'Xóa "{name}"?',
  deleteDescFile: 'Thao tác này sẽ xóa vĩnh viễn tệp. Không thể hoàn tác.',
  deleteDescDir: 'Thao tác này sẽ xóa vĩnh viễn thư mục và toàn bộ nội dung của nó. Không thể hoàn tác.',
  dismiss: 'Đóng',
  download: 'Tải xuống',
  ...
  settingsOpenToolsDesc: 'Khi bật, mô hình có thể mở tệp, thư mục và trang HTTP(S) trong thanh bên qua công cụ sidebar_open',
  ...
  settingsBrowserHttpsDesc: 'Khi bật, nhấp link HTTPS ngoài trong chat hoặc UI sẽ mở trong thanh bên.',
