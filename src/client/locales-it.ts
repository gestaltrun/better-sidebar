...
export const it: Record<string, string> = {
  ...
  guideDescSubagent: 'Topologia dei subagent e attività in background, in tempo reale',
  guideDescSidechat: 'Un thread di approfondimento indipendente che eredita il contesto della sessione',
  guideDescTerminal: 'Una vera shell (xterm + pty) con riconnessione',
  guideDescBrowser: 'Browser integrato, può aprire i link della chat',
  ...
  rename: 'Rinomina',
  renameInvalid: 'Il nome non può essere vuoto o contenere separatori di percorso.',
  delete: 'Elimina',
  deleteTitle: 'Eliminare "{name}"?',
  deleteDescFile: 'Il file verrà eliminato definitivamente. Questa azione non può essere annullata.',
  deleteDescDir: 'La directory e tutto il suo contenuto verranno eliminati definitivamente. Questa azione non può essere annullata.',
  dismiss: 'Chiudi',
  download: 'Scarica',
  ...
  settingsOpenToolsDesc: 'Se attivato, il modello può aprire file, cartelle e pagine HTTP(S) nella barra laterale tramite lo strumento sidebar_open',
  ...
  settingsBrowserHttpsDesc: 'Se attivato, cliccando un collegamento HTTPS esterno nella chat o nell’interfaccia si apre la barra laterale.',
  ...
  changesRedactOn: "Mascheramento attivo: i segreti appaiono come [REDACTED]; clicca per disattivare (a tuo rischio)",
  changesRedactOff: "Mascheramento disattivo: il contenuto appare invariato; clicca per attivare",
  changesRedactOnLabel: "Mascheramento",
